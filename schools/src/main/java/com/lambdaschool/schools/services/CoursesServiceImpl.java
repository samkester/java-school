...
import com.lambdaschool.schools.repositories.InstructorRepositoryThatWorks;
    ...
    implements CoursesService
{
     ...
     */
    @Autowired
    private InstructorRepositoryThatWorks instructorrepos;
        ...
        long courseid)
    {
        ...
        {
            throw new ResourceNotFoundException("Student and Course Combination Does Not Exist");
        }
    }
        ...
        long courseid)
    {
        ...
        {
            throw new ResourceAlreadyPresentException("Student and Course Combination Already Exists");
        }
    }
